...
def seed_default_intents(db_path: str | None = None) -> None:
    ...
    intents = [
        ...
        IntentSpec(
            ...
            category="profile",
            description="Capture the user's home address and save it as a location profile.",
            examples=[
                "My home address is 123 Main St",
                "Mi casa es Av. Vallarta 123",
                "Set my home address",
                "Save my home location",
                "Mi direccion de casa es Av. Vallarta 123",
            ],
            required_slots=[
                SlotSpec(
                    name="address_text",
                    type="string",
                    required=True,
                    prompt_key="clarify.location_address",
                    examples=["123 Main St", "Av. Vallarta 123, Guadalajara"],
                    critical=True,
                    semantic_text=True,
                    min_length=5,
                    reject_if_core_conversational=True,
            ...
            default_mode="aventurizacion",
            risk_level="low",
            handler="onboarding.location.set_home",
            enabled=True,
            intent_version="1.0.0",
            origin="factory",
        ),
        IntentSpec(
            ...
            category="profile",
            description="Capture the user's work address and save it as a location profile.",
            examples=[
                "My work address is 500 Market St",
                "Mi trabajo es Av. Vallarta 456",
                "Set my work address",
                "Save my work location",
                "Mi direccion de trabajo es Av. Vallarta 456",
            ],
            required_slots=[
                SlotSpec(
                    name="address_text",
                    type="string",
                    required=True,
                    prompt_key="clarify.location_work",
                    examples=["500 Market St", "Av. Vallarta 456, Guadalajara"],
                    critical=True,
                    semantic_text=True,
                    min_length=5,
                    reject_if_core_conversational=True,
            ...
            default_mode="aventurizacion",
            risk_level="low",
            handler="onboarding.location.set_work",
            enabled=True,
            intent_version="1.0.0",
            origin="factory",
        ),
        ...
        IntentSpec(
            ...
            category="debug_meta",
            description="List open capability gaps.",
            examples=["gaps list", "gaps", "lista de brechas"],
            required_slots=[],
            optional_slots=[],
            default_mode="aventurizacion",
            risk_level="low",
            handler="meta.gaps_list",
            enabled=True,
            intent_version="1.0.0",
            origin="factory",
        ),
        ...
        IntentSpec(
            ...
            examples=["prefiero", "actualiza mi preferencia", "cambia mi preferencia"],
            required_slots=[],
            optional_slots=[],
            default_mode="aventurizacion",
            risk_level="medium",
        ...
        IntentSpec(
            intent_name="lan.arm",
            category="control_plane",
            description="Arm a paired device or link.",
            examples=["arm link", "arm", "unlock", "arm alphonse link"],
            required_slots=[],
            optional_slots=[],
            default_mode="aventurizacion",
            risk_level="high",
        ...
        IntentSpec(
            intent_name="lan.disarm",
            category="control_plane",
            description="Disarm a paired device or link.",
            examples=["disarm", "lock", "disarm link"],
            required_slots=[],
            optional_slots=[],
            default_mode="aventurizacion",
            risk_level="high",
        ...
        IntentSpec(
            intent_name="pair.approve",
            category="control_plane",
            description="Approve a pairing request.",
            examples=["/approve", "approve"],
            required_slots=[],
            optional_slots=[],
            default_mode="aventurizacion",
            risk_level="medium",
            handler="pair.approve",
            enabled=True,
            intent_version="1.0.0",
            origin="factory",
        ),
        IntentSpec(
            intent_name="pair.deny",
            category="control_plane",
