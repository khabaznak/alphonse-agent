...
def seed_default_intents(db_path: str | None = None) -> None:
    ...
    intents = [
        ...
        IntentSpec(
            ...
            category="core_conversational",
            description="List users Alphonse has been introduced to.",
            examples=[
                "list users",
                "show users",
                "who are the users",
                "list people",
                "lista de usuarios",
                "muestrame los usuarios",
            ],
            required_slots=[],
            optional_slots=[],
            default_mode="aventurizacion",
            risk_level="low",
            handler="core.users.list",
            enabled=True,
            intent_version="1.0.0",
            origin="factory",
        ),
        ...
        IntentSpec(
            ...
            category="core_conversational",
            description="Store a labeled location (home/work/other).",
            examples=[
                "set my home address",
                "save my work address",
                "my home is avenida vallarta 123",
                "mi casa esta en avenida vallarta 123",
                "guardar ubicacion del trabajo",
            ],
            required_slots=[],
            optional_slots=[],
            default_mode="aventurizacion",
            risk_level="low",
            handler="core.location.set",
            enabled=True,
            intent_version="1.0.0",
            origin="factory",
        ),
