...
_SAFE_FALLBACKS: dict[str, dict[str, str]] = {
    "en": {
        ...
        "core.onboarding.authorize.completed": "Authorized {user_name} on {channel_type}.",
        "core.onboarding.introduce_authorize.completed": "Added and authorized {user_name} on {channel_type}.",
    ...
    "es": {
        ...
        "core.onboarding.authorize.completed": "Autorice a {user_name} en {channel_type}.",
        "core.onboarding.introduce_authorize.completed": "Agregue y autorice a {user_name} en {channel_type}.",
