...
_SAFE_FALLBACKS: dict[str, dict[str, str]] = {
    "en": {
        ...
        "core.onboarding.secondary.ask_name": "Sure. What is their name?",
        "core.onboarding.secondary.ask_relationship": "How are you related to them?",
        "core.onboarding.secondary.ask_role": "What role do they have? (e.g., Dad, Son)",
        "core.onboarding.secondary.completed": "Great. I added {user_name}.",
        "core.onboarding.authorize.ask_user": "Which person should I authorize?",
        "core.onboarding.authorize.ask_channel_type": "Which channel should I authorize (telegram, discord, etc)?",
        "core.onboarding.authorize.ask_channel_address": "What's the channel address or chat id?",
        "core.onboarding.authorize.user_not_found": "I could not find {user_name} in the users list.",
        "core.onboarding.authorize.completed": "Authorized {user_name} on {channel_provider}.",
        "core.onboarding.introduce_authorize.completed": "Added and authorized {user_name} on {channel_provider}.",
        "policy.authorize.restricted": "Only the admin can authorize new users.",
    ...
    "es": {
        ...
        "core.onboarding.secondary.ask_name": "Claro. Cual es su nombre?",
        "core.onboarding.secondary.ask_relationship": "Como te relacionas con esa persona?",
        "core.onboarding.secondary.ask_role": "Cual es su rol? (por ejemplo, Papa, Hijo)",
        "core.onboarding.secondary.completed": "Listo. Agregue a {user_name}.",
        "core.onboarding.authorize.ask_user": "A quien debo autorizar?",
        "core.onboarding.authorize.ask_channel_type": "Que canal debo autorizar (telegram, discord, etc)?",
        "core.onboarding.authorize.ask_channel_address": "Cual es el address o chat id del canal?",
        "core.onboarding.authorize.user_not_found": "No encontre a {user_name} en la lista de usuarios.",
        "core.onboarding.authorize.completed": "Autorice a {user_name} en {channel_provider}.",
        "core.onboarding.introduce_authorize.completed": "Agregue y autorice a {user_name} en {channel_provider}.",
        "policy.authorize.restricted": "Solo el admin puede autorizar nuevos usuarios.",
